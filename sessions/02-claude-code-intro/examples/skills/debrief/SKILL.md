---
name: debrief
description: Distill durable lessons from this session into the appropriate persistent file (user CLAUDE.md, repo CLAUDE.md, or project memory). Invoke explicitly with /debrief at the end of a working session.
